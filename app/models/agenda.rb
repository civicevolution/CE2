class Agenda < ActiveRecord::Base
  ...
  def participant_report_data(params)
    ...
    case layout
      ...
      when 'recommendation-results'
        ...
        data[:allocated_themes] = data[:vote_options]
        data[:allocated_themes].each do|theme|
          theme['count'] = "(#{theme[:votes]})"
          theme['text'] = theme['text'].split(/\n/)[0]
        end
  ...
  def refresh_agenda_details_links_and_data_sets
    ...
    link_code = self.create_link_code( agenda_details[:links][:lookup] )
    link = {
        title: %Q|Service Actions and Suggestions Voting|,
        id: 'mca',
        link_code:  link_code,
        href: "/#/mca/#{agenda_details[:mca_ids][0]}/directions-vote?mode=vote_actions_suggestions",
        #data_set: "coord-multi-criteria-analysis-table",
        mca_id: agenda_details[:mca_ids][0],
        page_title: "Plenary Services Review",
        disabled: false,
    ...
    link_code = self.create_link_code( agenda_details[:links][:lookup] )
    link = {
        title: %Q|Plenary Services Actions & Suggestions Review|,
        id: 'mca',
        link_code:  link_code,
        href: "/#/mca/#{agenda_details[:mca_ids][0]}/directions-vote?mode=view_actions_suggestions",
        #data_set: "coord-multi-criteria-analysis-table",
        mca_id: agenda_details[:mca_ids][0],
        page_title: "Plenary Services Review",
        disabled: false,
