class Ability
  ...
  @@conversation_actions_by_role[:scribe] = %i( edit_my_table_comment edit_synthesis tag_comment view_table_comments edit_table_comment post_prescreen history vote )
  @@conversation_actions_by_role[:themer] = %i( edit_all_table_comments edit_synthesis edit_table_comment edit_theme_comment assign_comment_theme post_prescreen history update_comment_order destroy_theme_comment hide).concat @@conversation_actions_by_role[:scribe]
