class Ability
  ...
  @@conversation_actions_by_role[:remote] = %i( conversation_rating edit_my_table_comment edit_synthesis tag_comment view_table_comments edit_table_comment post_prescreen history vote )
